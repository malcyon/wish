...
pasted into an issue arrives without its terminal.
    ...
    .venv/bin/python tools/gui/shotwindow.py                    # synthetic party
    .venv/bin/python tools/gui/shotwindow.py --empty             # nothing open
    .venv/bin/python tools/gui/shotwindow.py --font +6

...
`tools/gui/shotstrip.py` writes an effect table by hand.

    tools/gui/rostercard.py                       today's worst case, as numbers
    tools/gui/rostercard.py --badges 0 --no-readied
    tools/gui/rostercard.py --width 300 --out card.png
    tools/gui/rostercard.py --font +6             about Windows' base font
...
from tools.gui import shotwindow  # noqa: E402

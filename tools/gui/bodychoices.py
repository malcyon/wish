...
talking about.  I would need to see screenshots."*
    ...
    tools/gui/bodychoices.py                   # <tmp>/wish/bodychoices/bodies.png
    tools/gui/bodychoices.py --menu            # and menu.png, both menus
    tools/gui/bodychoices.py --all             # and all.png, every block
    tools/gui/bodychoices.py --out other.png

...
only place anybody sees it.
    ...
    .venv/bin/python tools/gui/messageshot.py panel.png
    .venv/bin/python tools/gui/messageshot.py --say "One line." shot.png
...
def _offscreen() -> None:
    ...
    Copied from `tools/gui/shotwindow.py`, and forced rather than defaulted for the

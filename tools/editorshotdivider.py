...
`tools/shotwindow.py` draws the window at its minimum size and cannot move a
...
heights to ask the editor's divider for, and the window size.
    ...
    tools/editorshotdivider.py OUT.png --font +16 --rows 700 1
    tools/editorshotdivider.py OUT.png --size 1366 768
...
def main(argv=None) -> int:
    ...
    from tools.shotwindow import caption, floor_of

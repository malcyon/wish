...
Two subcommands:
    ...
    tools/c64/inventorycheck.py stage \\
    ...
    tools/c64/inventorycheck.py run --save edited.D64 --pool N \\
...
def press_bar(sess, label: str, timeout: float = 25.0) -> bool:
    ...
    not, and giving it Curse's method is `tools/c64/session.py`'s change to make

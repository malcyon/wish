...
Three subcommands, and the order matters:
    ...
    tools/c64/c64ucompare.py hw   -o RUNS/hw-a  # twice, to find
    tools/c64/c64ucompare.py hw   -o RUNS/hw-b  # what free-runs
    tools/c64/c64ucompare.py vice -o RUNS/vice --save NEWSAVE6.D64
    tools/c64/c64ucompare.py diff RUNS/hw-a RUNS/vice \
        --stable RUNS/hw-b
...
* **VIC colour registers and colour RAM read back with the unused upper bits
  ...
  bits are not implemented; `tools/c64/c64u.mask_vic_colour` takes them off.
...
from tools.c64.c64u import NO_DEVICE, NotReachable, Ultimate  # noqa: E402
...
def in_vice(out: pathlib.Path, save: str, note: str,
    ...
    """
    from tools.c64.c64u import disk_dir
    from tools.c64.session import Session, claim_slot, stage_disks

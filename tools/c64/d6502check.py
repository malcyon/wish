#!/usr/bin/env python3
"""Check `tools/c64/d6502.py` against capstone, on the table and on real code.
...
records that as a known difference rather than a fault.
    ...
    tools/c64/d6502check.py                 both sweeps
    tools/c64/d6502check.py --table
...
def main(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(
        description="Compare tools/c64/d6502.py with capstone.")

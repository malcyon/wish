...
afterwards.
    ...
    tools/c64/abilitypair.py read WISH-SPEC-curse-h-engine-resave.D64
    tools/c64/abilitypair.py stage --base in.D64 --out DIR/x.D64 \\
        --set PHILIPPE:str=9/18 --set SHARA:str=18/9
    tools/c64/abilitypair.py refs curse-of-the-azure-bonds

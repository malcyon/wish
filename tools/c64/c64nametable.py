...
disk's filenames.
    ...
    tools/c64/c64nametable.py show DISK [DISK ...]
    tools/c64/c64nametable.py sites --title curse-of-the-azure-bonds
    tools/c64/c64nametable.py run --save DISK --out DIR [--pool N] [--remove NAME]

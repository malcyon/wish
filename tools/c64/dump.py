...
Discovery tool -- not part of the shipped editor.
    ...
    tools/c64/dump.py SAVE.D64                         # disk directory + save summary
    tools/c64/dump.py tests/fixtures/brutus.chr        # one character record
    tools/c64/dump.py SAVE.D64 --raw SAVEDGAME0 --range 0x4c00-0x4cff
"""

...
"""Check the BAM header of every disk image against the layout we documented.
    ...
    tools/c64/bamsweep.py                       every disk under $POR_DISKS
    tools/c64/bamsweep.py /path/to/images       every .d64 in a directory
    tools/c64/bamsweep.py A.D64 B.D64           named images
    tools/c64/bamsweep.py --quiet               the tallies only

...
which is what the loop reads four instructions after the THAC0 lookup.
    ...
    tools/c64/laterthac0.py table --title curse-of-the-azure-bonds
    tools/c64/laterthac0.py compare --title secret-of-the-silver-blades
    tools/c64/laterthac0.py records --title curse-of-the-azure-bonds
    tools/c64/laterthac0.py writers --title curse-of-the-azure-bonds

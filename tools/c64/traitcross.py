...
ticket is about -- any id that was in the source and reached no slot.
    ...
    tools/c64/traitcross.py ~/wish-specimens/por-dos/WISH-SPEC-curse-131-four-items-readied
    tools/c64/traitcross.py --all                      # every DOS specimen
    tools/c64/traitcross.py --c64 ~/wish-specimens/por-c64/WISH-SPEC-curse-h-engine-resave.D64

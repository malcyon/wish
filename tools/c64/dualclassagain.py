...
and photographs what the game does.
    ...
    tools/c64/dualclassagain.py c64 --save ~/wish-specimens/por-c64/WISH-SPEC-curse-dual-classed.D64
    tools/c64/dualclassagain.py c64 --save ... --serve     # boot and hand over

    tools/c64/dualclassagain.py dos --game CURSE --party <tree>
    tools/c64/dualclassagain.py dos --game SECRET --party <tree> --from-slot C --slot C \

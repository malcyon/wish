...
`tools/c64/c64urest.py` has the transport -- REST for the machine, FTP for a file --
...
`docs/177-a-load-that-goes-wrong.md`.
    ...
    tools/c64/c64uplay.py boot POOL1.D64 --mode readonly
    tools/c64/c64uplay.py mount NEWSAVE6.D64 --mode readwrite
    tools/c64/c64uplay.py screen
    tools/c64/c64uplay.py keys Y --wait
    tools/c64/c64uplay.py probe ' '
    tools/c64/c64uplay.py wait --contains "onward bound" --timeout 200
    tools/c64/c64uplay.py burst --seconds 20 --out DIR
    tools/c64/c64uplay.py regions --out DIR --note "after the exit"
    tools/c64/c64uplay.py alive --seconds 10
...
from tools.c64.c64urest import (  # noqa: E402
    DeviceError,
    Rest,
    find_host,
    first_prg,

...
unchanged one.
    ...
    tools/c64/c64portraitprobe.py --disk PORSAVE12.D64 --view 0 5
    tools/c64/c64portraitprobe.py --disk PORSAVE12.D64 --words 49FF=0
    tools/c64/c64portraitprobe.py --disk PORSAVE12.D64 --portrait 0=2D/25
...
def answer_bars(sess, answer: str = "NO", seconds: float = 240.0) -> str:
    ...
    loop `tools/c64/savecheck.py` uses, kept short here because this tool wants

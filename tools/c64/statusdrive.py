...
writing one:
  ...
  4. `ENCAMP > SAVE`, then read `SAVEDGAME1` back off the disk the game wrote,
    ...
    tools/c64/statusdrive.py --save PORSAVE13.D64 --slot 3 --victim 5
    tools/c64/statusdrive.py --sheets --save-path /path/to/saved.d64
...
with bit 7 clear is what says whether the two are one field or two:
    ...
    tools/c64/statusdrive.py --panel --save-path /path/to/saved.d64 \

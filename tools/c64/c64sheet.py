...
own sheet against the source, read as words rather than as bytes.
    ...
    tools/c64/c64sheet.py ~/wish-specimens/por-c64/WISH-SPEC-curse-trained-party.D64
...
#: `tools/curse_of_the_azure_bonds/cursedisk.py` has it.  The sheet shows the decoded number.
AC_BIAS = 60
SEXES = ("MALE", "FEMALE")

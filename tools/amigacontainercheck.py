...
`goldbox.amiga.new_por_savegame` builds all 13,141 bytes of a
...
numeric offsets, big-endian, rather than through `goldbox.amiga.por_word` or
...
def container_fields(save: bytes) -> dict:
    ...
    the tail.  Nothing here calls `goldbox.amiga.por_word`.
    """

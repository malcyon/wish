...
record `id 00 00 0C 00`.  This puts both claims to the running game:
    ...
    tools/dos/dosspcexpiry.py chain --slot J --steps 4
    tools/dos/dosspcexpiry.py ready --slot J --char 1 --item 1 --effect 61
...
and reads the game out of the player's archives through `tools/dos/dosbox.py`;

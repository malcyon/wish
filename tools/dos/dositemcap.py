...
engine's answer.  `.claude/rules/testing.md` is the distinction.
    ...
    tools/dos/dositemcap.py --interactive          # boot, then read step lines
    tools/dos/dositemcap.py --counts 2,15,16       # install and boot only

Steps are `tools/dos/dosgnome.py`'s vocabulary: a bare X keysym is a keypress,

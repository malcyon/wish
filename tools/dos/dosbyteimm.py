...
`tools/dos/dosfieldrefs.py` counts the instructions that touch a record offset and
...
from the Curse decompilation)`).
    ...
    tools/dos/dosbyteimm.py <POOLRAD/GAME.OVR> --offset 0x0BF
    tools/dos/dosbyteimm.py <CURSE/GAME.OVR> --offset 0x143 --sites

**It inherits every limit of `tools/dos/dosfieldrefs.py`, and adds none of its

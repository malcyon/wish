...
"""What a DOS Gold Box engine's *save* routine writes, region by region.
    ...
    tools/dos/dossavewritemap.py                     # every title the archives hold
    tools/dos/dossavewritemap.py --game CURSE
    tools/dos/dossavewritemap.py --path /some/GAME.OVR --check
...
#: The titles this understands, as the stem `tools/dos/dosbox.py` finds them by.

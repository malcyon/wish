...
"""Read what DOS Pool of Radiance seeds a new character with, and what 97 does.
    ...
    tools/dos/dosracialseed.py                     # the archives' GAME.OVR, START.EXE
    tools/dos/dosracialseed.py --game-dir DIR      # a directory holding both files
...
from tools.dos import dosovrmap, unexepack  # noqa: E402

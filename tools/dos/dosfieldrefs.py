...
A companion to `tools/dos/dosfightwatch.py` for the half of `#69 (No
...
loaded across the fight.
    ...
    tools/dos/dosfieldrefs.py DIR/memory-*.bin --offset 0x100
    tools/dos/dosfieldrefs.py DIR/*/memory-*.bin --unsourced
"""

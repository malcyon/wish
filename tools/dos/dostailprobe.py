...
photographs the party panel, and takes the engine's own `ENCAMP > SAVE` back:
    ...
    tools/dos/dostailprobe.py                  # the default six-value pattern
    tools/dos/dostailprobe.py --pattern 0:04000000,1:06000000
    tools/dos/dostailprobe.py --field field_83_87 --pattern 0:0000FF0000

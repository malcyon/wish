...
dump.
    ...
    tools/dos/daxls.py CBODY.DAX                  # the index: id, sizes, image header
    tools/dos/daxls.py CBODY.DAX --dump 64 cbody-64.bin
    tools/dos/daxls.py CHEAD.DAX --png 3 chead-3.png --scale 8

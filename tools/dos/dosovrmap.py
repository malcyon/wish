...
"""Map DOS Pool of Radiance's overlay units, resolve far calls, and read code.
    ...
    tools/dos/dosovrmap.py units      GAME.OVR START.img
    tools/dos/dosovrmap.py resolve    GAME.OVR START.img B0:52
    tools/dos/dosovrmap.py dis        GAME.OVR START.img 0x23DCC 0x240C0
    tools/dos/dosovrmap.py callers    GAME.OVR START.img 0x2BD3C [--back 60]

`START.img` is `START.EXE` expanded by `tools/dos/unexepack.py`; the overlay
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("img", help="START.EXE expanded by tools/dos/unexepack.py")

...
matters.**  `tools/dos/dostrainprobe.py` measured that Pool of Radiance gates
...
trains whoever is highlighted and `y` accepts.
    ...
    tools/dos/dostrain.py --party $WISH_SPECIMENS/por-dos/WISH-SPEC-por-party-l1-intown \\

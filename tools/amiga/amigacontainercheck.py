...
"""Check that a built Amiga saved game carries the source save's own place.
    ...
    tools/amiga/amigacontainercheck.py                       every C64 specimen
    tools/amiga/amigacontainercheck.py SAVE.d64 OTHER.d64    two named saves
    tools/amiga/amigacontainercheck.py --data-disk pool2.adf --game-disk pool1.adf
    tools/amiga/amigacontainercheck.py --out container.md

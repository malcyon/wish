...
`tools/amiga/porslot.py` does this for Amiga *Pool of Radiance*, whose party is six
...
measurement.
    ...
    tools/amiga/amigalaterslot.py copy-of-curseA.adf --to B --out run.adf
    tools/amiga/amigalaterslot.py copy-of-curseA.adf --to C --out run.adf \\
...
from tools.amiga import amigasavecheck  # noqa: E402

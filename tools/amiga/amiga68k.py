...
project's virtual environment carries.
    ...
    tools/amiga/amiga68k.py --adf copy-of-curse-A.adf --exe /Curse refs 274b4
    tools/amiga/amiga68k.py --adf copy-of-curse-A.adf --exe /Curse disasm 26af8 26d6c
    tools/amiga/amiga68k.py --file exe/program hunks

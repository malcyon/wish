    ...
    "curse-of-the-azure-bonds": Title(
        ...
        unguarded=Loop(
            ...
            proof=(
                ...
                Instruction(0x38A5E, "moveq", "#$0, d2"),
                Instruction(0x38A60, "bra.w", "$38af4"),
                Instruction(0x38A64, "move.b", "d2, d0"),
                Instruction(0x38A66, "ext.w", "d0"),
                Instruction(0x38A68, "movea.l", "a2, a0"),
                Instruction(0x38A6A, "adda.w", "#$10a, a0"),
                Instruction(0x38A6E, "move.b", "(a0, d0.w), d3"),
                Instruction(0x38A72, "move.b", "d2, d0"),
                Instruction(0x38A74, "ext.w", "d0"),
                Instruction(0x38A76, "muls.w", "#$d, d0"),
                Instruction(0x38A7A, "move.b", "d3, d1"),
                Instruction(0x38A7C, "ext.w", "d1"),
                Instruction(0x38A7E, "ext.l", "d1"),
                Instruction(0x38A80, "add.l", "d1, d0"),
                Instruction(0x38A82, "lea.l", "-$64ce(a4), a0"),
                Instruction(0x38A86, "move.b", "(a0, d0.l), d0"),
                Instruction(0x38A8A, "cmp.b", "$73(a2), d0"),
                Instruction(0x38A8E, "bls.b", "$38aaa"),
                Instruction(0x38A90, "move.b", "d2, d0"),
                Instruction(0x38A92, "ext.w", "d0"),
                Instruction(0x38A94, "muls.w", "#$d, d0"),
                Instruction(0x38A98, "move.b", "d3, d1"),
                Instruction(0x38A9A, "ext.w", "d1"),
                Instruction(0x38A9C, "ext.l", "d1"),
                Instruction(0x38A9E, "add.l", "d1, d0"),
    ...
    "secret-of-the-silver-blades": Title(
        ...
        unguarded=Loop(
            ...
            proof=(
                ...
                Instruction(0x3C80E, "moveq", "#$0, d2"),
                Instruction(0x3C810, "bra.w", "$3c8b6"),
                Instruction(0x3C814, "move.b", "d2, d0"),
                Instruction(0x3C816, "ext.w", "d0"),
                Instruction(0x3C818, "movea.l", "a2, a0"),
                Instruction(0x3C81A, "adda.w", "#$ac, a0"),
                Instruction(0x3C81E, "move.b", "(a0, d0.w), d3"),
                Instruction(0x3C822, "move.b", "d2, d0"),
                Instruction(0x3C824, "ext.w", "d0"),
                Instruction(0x3C826, "muls.w", "#$26, d0"),
                Instruction(0x3C82A, "move.b", "d3, d1"),
                Instruction(0x3C82C, "ext.w", "d1"),
                Instruction(0x3C82E, "ext.l", "d1"),
                Instruction(0x3C830, "add.l", "d1, d1"),
                Instruction(0x3C832, "add.l", "d1, d0"),
                Instruction(0x3C834, "lea.l", "-$61ce(a4), a0"),
                Instruction(0x3C838, "moveq", "#$0, d1"),
                Instruction(0x3C83A, "move.b", "$6a(a2), d1"),
                Instruction(0x3C83E, "move.w", "(a0, d0.l), d0"),
                Instruction(0x3C842, "cmp.w", "d1, d0"),
                Instruction(0x3C844, "ble.b", "$3c862"),
                Instruction(0x3C846, "move.b", "d2, d0"),
                Instruction(0x3C848, "ext.w", "d0"),
                Instruction(0x3C84A, "muls.w", "#$26, d0"),
                Instruction(0x3C84E, "move.b", "d3, d1"),
                Instruction(0x3C850, "ext.w", "d1"),
                Instruction(0x3C852, "ext.l", "d1"),
                Instruction(0x3C854, "add.l", "d1, d1"),
                Instruction(0x3C856, "add.l", "d1, d0"),

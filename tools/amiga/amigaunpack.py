...
`docs/166-amiga-records-from-the-code.md` is written from.
    ...
    tools/amiga/amigaunpack.py --file CURSE.EXE --size 0x1ac \\
        --shape curse-of-the-azure-bonds 270a6 273ea
    tools/amiga/amigaunpack.py --adf CURSE-A.adf --exe /Curse \\
...
from tools.amiga.amiga68k import Executable, disassemble, load  # noqa: E402

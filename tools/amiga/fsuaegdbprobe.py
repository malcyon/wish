...
Amiga game run on one machine?)`.
    ...
    .venv/bin/python tools/amiga/fsuaegdbprobe.py [PORT]
...
`tools/amiga/fsuaegdb.py` is the shipped command line, built on `automap/amiga.py`'s
transport; this is the earlier standalone client. `tools/amiga/fsuaeprobedrive.py`

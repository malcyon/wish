...
| [142-dosbox-x-debugger.md](142-dosbox-x-debugger.md) | the DOS side's answer to VICE's binary monitor: a DOSBox-X built with the debugger, driven unattended over a pty, and the memory reads, watchpoints and breakpoints it does and does not give |

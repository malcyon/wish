...
`npc_party.d64` with the hand-rolled version of this, `tools/exitreentry.py`
...
ViceTarget` (2026-09-08, driver `tools/fasttravelrun.py`): production code
...
`automap/fasttravel.py`'s `EXIT_ROUTES`, generated by `tools/genexits.py`,

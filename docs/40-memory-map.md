...
`$9E00`. `tests/records/test_titletables.py` asserts it per title. The race labels are the
...
`tests/records/test_titletables.py`; the write-up, `reports/p40-title-tables.md`,
is lost.

...
| **Which DAX holds which art**: `CHEAD`/`CBODY` are the combat icon's head/body images, `BODY1-8`/`CPIC1-8` monster combat sprites, `COMSPR` tactical figures, `8X8D1-8` wall tile sets, `WALLDEF1-8` the face composition tables | `docs/168-dos-dax-and-combat-icons.md` maps the icon images to the loader and record fields | CONFIRMED |

...
DROPPED: tuple[tuple[str, str], ...] = (
    ...
    ("running_effects", "the C64 keeps a running effect in the save's own "
                        ...
                        "built. Three of the four parts are settled: the "
                        "camp-clock time, through "
                        "`goldbox.effects.closest_duration`; the slot and the "
                        "owner, through `goldbox.effects.free_slot` and "
                        "`slot_for`, which are the engines' own allocator; and "
                        "the value for the later titles' Mirror Image, "
                        "Strength, Enlarge and Friends, which hold a modifier "
                        "rather than the score they replaced. What is left is "
                        "Pool of Radiance's overlapping Strength nodes, which "
                        "the C64 engine cannot hold two of at once, Pool's "
                        "party-wide Prayer row, the ids nobody has read, and "
                        "two ageing routes -- combat ages only unit 00, and "
                        "Silver Blades' walking rule differs from Pool's and "
                        "Curse's "

...
DROPPED: tuple[tuple[str, str], ...] = (
    ...
    ("running_effects", "the C64 keeps a running effect in the save's own "
                        ...
                        "built. The time is settled: "
                        "`goldbox.effects.longest_duration_within` turns the "
                        "source's minutes into the count and unit the "
                        "destination's own clock makes of them, from the camp "
                        "ageing routine of all three titles. The value is not "

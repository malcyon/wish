...
_DECLARED: Sequence[Field] = (
    ...
    _field(0x0AD, 10, _RAW, "item_effects", "Character Traits", _MAYBE,
           ...
           "kobolds. Three ids agree (26, 47 and the paladin's 45) and five "
           ...
           "Silver Blades GEN $0FF0. #186 is the editor showing Pool of "
           "Radiance's names for them; tools/coldread.py traits reads the "

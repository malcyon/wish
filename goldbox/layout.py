...
_DECLARED: Sequence[Field] = (
    ...
    _field(0x07F, 9, _RAW, "spells_known_high", "Spellbook (high ids)", _OK,
           ...
           "encode the open title's width over both fields (#85, #87), "
           ...
           "2026-09-02 (#31)**, having been written at each overlay's PRG "
           "header base -- $1000, $1220, $3000, $4000 -- where GEN and CAMP "
           "both run at $0800 in all three titles. The instructions and the "
           "widths were right and the addresses named bytes in the middle of "
           "something else, so nobody checking one with tools/overlay.py, "
    ...
    _field(0x0E3, 5, _RAW, "region_0e3", "unknown @0x0E3", _NOPE,
           ...
           "docs/50-experiments.md and #224",
           candidate=True),
    ...
    _field(0x0AD, 10, _RAW, "item_effects", "Character Traits", _MAYBE,
           ...
           "**The seeding is per title, and so is the namespace (#31).** The "
           ...
           "Silver Blades GEN $0FF0. #186 gave Silver Blades its own table "
    ...
    _field(0x100, 1, _U8, "roster_in_use", "Roster in use", _OK,
           ...
           "nothing else (#104) -- and any other value is a state the sheet "
           ...
           "three bits** (#235): $81 -- OK with bit 7 set -- draws OK on the "
    ...
    _field(0x0EC, 1, _I8, "missile_attack_adjustment",
           ...
           "nothing for their byte to do. #202"),

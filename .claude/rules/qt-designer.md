...
compiled with `tools/generate/genui.py`; `tools/generate/genui.py --check` is what CI runs and
...
**`tools/generate/genui.py` compiles every `.ui` in the project.** It discovers pairs

...
It resolves the sha, adds a detached worktree there, symlinks `work/` and
`gamedisks.yaml` into it (both gitignored, and without them every specimen-
and disk-backed test skips), runs `pytest

...
**Run `pytest` on the files you touched, plus `ruff`, before you report.** The
whole suite runs once, in a detached worktree, before the push — not from
inside this task. `.claude/rules/commits.md` has the detail.

...
| file | purpose |
|---|---|
| `__init__.py` | The package docstring recording that rule: `tests/wish/test_wish.py::test_editor_imports_nothing_live` greps every file in `editor/` for the word `automap`, so shared drawing code cannot live there. |

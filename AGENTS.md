...
| a sentence that rates itself by any other route: **"says so out loud"**, "the important thing here", "note that", **"narrower than it looks"**, "worse than it looks", "worse than I said", "the interesting kind", "the thing to look at hardest", "this is the useful part" | delete the rating and keep the sentence -- you would not have written it otherwise. Donald, 2026-09-09: *"This is unnecessary filler. Shouldn't caveman lite prevent you from saying things like this?"* It should; the whole family is banned, not the three examples |

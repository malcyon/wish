...
from support.cursetables import (
    ART_FLOOR,
    BARRIER_FLOOR,
    MANGLED_ART_CEILING,
    MEAN_FLOOR,
...
#: is relocated low. 0x0800 is Curse's overlay base as well --
#: `tests/curse_of_the_azure_bonds/test_curse.py::_cleric_grant_table` asserts
#: it there -- and it is what makes the

...
`tests/curse_of_the_azure_bonds/test_cursetrainer.py` included -- compared the fields and never the
...
#: `tests/curse_of_the_azure_bonds/test_cursetrainer.py` excludes them -- a roll leaves no trace in a

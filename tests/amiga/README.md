...
| `test_amigasecretsave.py` | Checks that a failed WinUAE save probe leaves the published disk unchanged, keeps both fetched ADFs and its last screen, and settles a capture on the emulator's crop. |

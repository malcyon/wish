...
| `test_amigabackstab.py` | Pins what `tools/amiga/amigabackstab.py` reads out of each Amiga title's own executable: the multiplier arithmetic, its three predicate callers, the record bytes it loads and Pools of Darkness' clamp. |

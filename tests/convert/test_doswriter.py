...
The other half of `tests/convert/test_dosconvert.py`.  That module proves the DOS
...
def test_an_amiga_source_writes_its_own_identity_byte_not_a_digest():
    ...
    (`tests/amiga/test_amiga.py`), which is the party with a `.itm` file beside
    it.
    """
...
def test_the_amiga_port_of_pool_of_radiance_keeps_a_fighting_level():
    ...
    `tests/amiga/test_amiga.py::test_a_specimen_round_trips_through_the_neutral_record`

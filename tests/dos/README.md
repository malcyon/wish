...
| `test_dospod.py` | Checks the step grammar of `tools/dos/dospod.py`, where it finds the Pools of Darkness game directory, and that it answers the copy-protection question without ever pressing `Return` on the party menu. |

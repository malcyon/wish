...
from goldbox import amiga, c64_codec, dos, neutral
...
def test_a_party_on_the_menus_first_head_still_switches_portraits_on(
    ...
    monkeypatch.setattr(amiga, "new_por_savegame", fake_new_por_savegame)
    monkeypatch.setattr(amiga, "make_por_save_disk", fake_make_por_save_disk)
    monkeypatch.setattr(amiga, "write_por", fake_write_por)

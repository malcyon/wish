...
| `test_world_state.py` | Checks that `goldbox/world_state.py`'s `WorldState` reads a title's own C64 and DOS specimens to the same answer and carries the five fields added over `PorSaveState`. |

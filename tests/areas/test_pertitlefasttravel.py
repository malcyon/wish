...
`#15 (Fast Travel for more than one Gold Box title)`. `tests/areas/test_newecl.py`
...
def test_the_wall_slots_are_unpinned_in_every_title():
    ...
    other two. `tests/areas/test_newecl.py` re-derives it off the disks; this is the
